...
const PUBLIC_PATHS = ['/', '/login', '/login/ogretmen', '/login/veli', '/register', '/register/ogretmen', '/register/veli', '/kvkk', '/pricing', '/forgot-password', '/yonetici', '/paketler', '/hakkimizda', '/iletisim', '/gizlilik-politikasi', '/mesafeli-satis-sozlesmesi', '/iade-ve-teslimat-sartlari'];
