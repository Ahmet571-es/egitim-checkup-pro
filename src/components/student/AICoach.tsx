...
export default function AICoach() {
  ...
  return (
    <div className="bg-white/80 dark:bg-slate-800/60 backdrop-blur-xl rounded-2xl border border-white/40 dark:border-slate-700/60 shadow-sm overflow-hidden flex flex-col" style={{ height: '500px' }}>
      {/* Header */}
      <div className="px-5 py-4 border-b border-gray-100 dark:border-slate-700/60 bg-gradient-to-r from-violet-500 to-purple-600">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <p className="text-sm text-gray-500 dark:text-slate-400 font-medium">Merhaba! Ben senin AI koçunum.</p>
          ...
          <div key={i} className={`flex gap-2.5 ${msg.role === 'user' ? 'flex-row-reverse' : ''}`}>
            ...
            <div className={`max-w-[80%] rounded-2xl px-4 py-2.5 text-sm leading-relaxed ${
              msg.role === 'user'
                ...
                : 'bg-gray-100 dark:bg-slate-700/60 text-gray-700 dark:text-slate-300 rounded-tl-md'
            }`}>
              {msg.content.split('\n').map((line, j) => (
        ...
        {loading && (
          <div className="flex gap-2.5">
            ...
            <div className="bg-gray-100 dark:bg-slate-700/60 rounded-2xl rounded-tl-md px-4 py-3">
      ...
      {/* Input */}
      <div className="p-3 border-t border-gray-100 dark:border-slate-700/60">
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-4 py-2.5 bg-gray-50 dark:bg-slate-800/60 border border-gray-200 dark:border-slate-700 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent disabled:opacity-50"
          />
          <button
            onClick={sendMessage}
