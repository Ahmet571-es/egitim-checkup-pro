...
export default function EmptyState({
  ...
  return (
    <div className="relative bg-white/80 dark:bg-slate-800/60 backdrop-blur-xl rounded-3xl border border-white/50 dark:border-slate-700/60 p-12 text-center shadow-sm overflow-hidden empty-enter">
      <div className={`absolute -top-20 -right-20 w-60 h-60 rounded-full bg-gradient-to-br ${blob} opacity-30 dark:opacity-20 blur-3xl`} />
      <div className={`absolute -bottom-20 -left-20 w-56 h-56 rounded-full bg-gradient-to-br ${blob} opacity-20 dark:opacity-15 blur-3xl`} />
      <div className="relative">
        ...
        <p className="text-[17px] text-[#0f2847] dark:text-slate-100 font-extrabold mb-2">{title}</p>
        {subtitle && (
