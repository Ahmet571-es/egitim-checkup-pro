  ...
  return (
    <div className="flex items-center gap-2 mb-4">
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-white/70 dark:bg-slate-800/50 backdrop-blur-xl border border-white/40 dark:border-slate-700/60 shadow-sm text-[12px] font-semibold text-[#0f2847] dark:text-slate-100 hover:bg-white dark:bg-slate-800 hover:shadow-md hover:-translate-y-0.5 transition-all"
      >
