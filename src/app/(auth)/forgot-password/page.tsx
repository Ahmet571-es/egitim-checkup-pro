          ...
          <div className="p-3.5 rounded-xl bg-blue-50 border border-blue-200 text-[12.5px] text-blue-800">
            ...
            <ol className="space-y-1 ml-4 list-decimal">
              ...
              <li>
                ...
                (öğretmenseniz <Link href="/login/ogretmen" className="underline font-bold">/login/ogretmen</Link>,
                değilseniz <Link href="/login" className="underline font-bold">/login</Link>),
