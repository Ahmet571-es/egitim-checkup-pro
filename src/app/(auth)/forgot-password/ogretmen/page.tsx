...
export default function TeacherForgotPasswordPage() {
  // 1: email gir, 2: kod gir, 3: yeni şifre, 4: başarılı
  ...
  return (
    <AuthLayout
      ...
      subtitle="Öğretmen hesabınız için yeni şifre belirleyin"
      footer={
    ...
    >
      ...
      {step === 2 && (
        <div className="space-y-4">
          <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 text-[13px] text-emerald-800">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3 rounded-xl border border-gray-200 bg-white text-sm text-center text-lg font-bold tracking-[0.3em] focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-400"
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex-1 py-3 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 text-white text-sm font-bold shadow-lg transition-all flex items-center justify-center gap-2 disabled:opacity-60"
            >
