    ...
    return (
      ...
      >
        <div className="space-y-4">
          ...
          <Link
            href="/login/veli"
            className="block text-center py-3 rounded-xl bg-gradient-to-r from-pink-500 to-rose-600 text-white text-sm font-bold shadow-lg hover:shadow-xl transition-all"
          >
            Giriş Sayfasına Dön
          </Link>
          ...
          <button
            ...
            className="w-full py-2.5 text-[12.5px] text-gray-500 hover:text-pink-600 font-semibold transition"
          >
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full py-3.5 rounded-xl bg-gradient-to-r from-pink-500 to-rose-600 hover:from-pink-600 hover:to-rose-700 text-white font-extrabold shadow-lg shadow-pink-500/30 transition-all active:scale-[0.98] disabled:opacity-50 flex items-center justify-center gap-2"
        >
          {loading ? (
            <>
